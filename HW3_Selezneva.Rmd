...
```{r}
# Описательные статистики для glucose, pressure, mass
descript_stats_continuous <- summary(pima[, c("glucose", "pressure", "mass")])

# Количество наблюдений
total_obs <- nrow(pima)

cat("Количество наблюдений для каждой переменной:", total_obs, "\n\n")
cat("Описательные статистики для glucose, pressure, mass:\n")
...
```{r}
# Построение диаграммы рассеяния без указания конкретных цветов
